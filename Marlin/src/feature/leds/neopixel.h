...
public:
    ...
    static void set_background_color(const uint8_t (&rgbw)[4])
    {
        set_background_color(rgbw[0], rgbw[1], rgbw[2], rgbw[3]);
    }
    ...
    {
        return adaneo1.numPixels() * TERN1(NEOPIXEL2_INSERIES, 2);
    }

    static uint8_t brightness()
    {
        return adaneo1.getBrightness();
    }
...
public:
    ...
    static uint16_t pixels()
    {
        return adaneo.numPixels();
    }
    static uint8_t brightness()
    {
        return adaneo.getBrightness();
    }
