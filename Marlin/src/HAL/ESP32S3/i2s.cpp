...
//based on https://gist.github.com/xw901103/5ff1c37590d2a4659ef09fe2a4babc3d
...
esp_err_t i2s_start(i2s_port_t i2s_num)
{
    ...
    I2S[i2s_num]->rx_conf.rx_reset = 1;
    I2S[i2s_num]->rx_conf.rx_reset = 0;

    //I2S[i2s_num]->int_clr.val = 0xFFFFFFFF;
    //I2S[i2s_num]->out_link.start = 1;
    I2S[i2s_num]->rx_conf.rx_start = 1;
...
esp_err_t i2s_stop(i2s_port_t i2s_num)
{
    ...
    I2S[i2s_num]->rx_conf.rx_start = 0;
...
int i2s_init()
{
    ...
    for (int buf_idx = 0; buf_idx < DMA_BUF_COUNT; buf_idx++) {
        ...
        if (dma.buffers[buf_idx] == nullptr) {
            return -1;
        }
    }
    ...
    I2S0.rx_conf.rx_pdm2pcm_en = 0;

    //I2S0.fifo_conf.dscr_en = 0;

    I2S0.tx_conf.tx_chan_mod = TERN(I2S_STEPPER_SPLIT_STREAM, 4, 0);
    //I2S0.tx_conf.tx_fifo_mod = 0;
    I2S0.tx_conf.tx_mono = 0;

    //I2S0.rx_conf.rx_chan_mod = 0;
    //I2S0.rx_conf.rx_fifo_mod = 0;
    ...
    I2S0.tx_clkm_conf.clk_en = 0;
    I2S0.rx_clkm_conf.rx_clkm_div_num = 10;// minimum value of 2, reset value of 4, max 256
    I2S0.tx_clkm_conf.tx_clkm_div_num = 10;// minimum value of 2, reset value of 4, max 256
    ...
    gpio_matrix_out_check(I2S_DATA, I2S0O_SD1_OUT_IDX, 0, 0);
#endif
